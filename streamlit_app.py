...
st.latex(r''' 
V^{xy}_{ \omega} = \frac{2}{t_f(3/4)} \sum^{4000}_{i=1000} (J_x_i m_z_i R_{AHE}) \sin( \omega t_i) (\Delta t)_i \\
V^{xy}_{2\omega} = \frac{2}{t_f(3/4)} \sum^{4000}_{i=1000} (J_x_i m_z_i R_{AHE}) \cos(2\omega t_i) (\Delta t)_i
''')
