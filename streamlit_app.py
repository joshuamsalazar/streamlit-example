...
\vec{ H }^{\text{SOT}}_{\text{FL}} = \eta_\text{FL} \frac{ \eta_{ j_e \hbar } }{ 2 e t \mu_0 M_s }\:\vec{m} \times \vec{m} \times \vec{p} \\
\vec{ H }^{\text{SOT}}_{\text{DL}} = \eta_\text{DL} \frac{ \eta_{ j_e \hbar } }{ 2 e t \mu_0 M_s }\:\vec{m} \times \vec{p}
''')
